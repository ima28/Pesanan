...
public class ListAdapter extends ArrayAdapter {
    ...
    public ListAdapter(@NonNull LainFragment context, int[] icon, String[] headline, String[] subhead) {
        super(context, R.layout.custom_list, headline);
        this.Icon = icon;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = layoutInflater.inflate(R.layout.custom_list, null, true);
